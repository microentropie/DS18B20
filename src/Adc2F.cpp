...
// returns: an integer containing temperature in Farenheit
//          example 42 means 42 Farenheit
int ADC2F(int16_t t)
{
  if (t == DS18X_INVALID_READ) return DS18X_INVALID_READ;
  int32_t raf0 = (t < 0) ? -5200 : 5200; // 'AwayFromZero' round-up
  return (int)(((int32_t)t * 18 + raf0) / 160);
}
